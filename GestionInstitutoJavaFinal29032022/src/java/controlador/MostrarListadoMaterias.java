/*
Servlet para mostrar el listado de materias
 */
package controlador;
 ...
 * @author daw2
 */
public class MostrarListadoMaterias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        getServletContext().getRequestDispatcher("/admin/mostrarMaterias.jsp").forward(request, response);
