/*
Servlet para mostrar el listado de evaluaciones
 */
package controlador;
 ...
 * @author daw2
 */
public class MostrarListadoEvaluaciones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        getServletContext().getRequestDispatcher("/admin/mostrarEvaluaciones.jsp").forward(request, response);
    }
