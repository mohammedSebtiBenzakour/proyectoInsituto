/*
Servlet para mostrar el listado de cursos en pdf
 */
package controlador;
 ...
 * @author daw2
 */
public class PdfCursos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Query consultaC = em.createQuery("Select c From Curso c");

            listaCursos = consultaC.getResultList();
            ...
            Paragraph parrafo1 = new Paragraph("Listado de todos los cursos", fuente);
            ...
            table.addCell(new Paragraph("Año Curso"));
            table.addCell(new Paragraph("Descripción del curso"));
            table.addCell(new Paragraph("Fecha de creación del curso"));
            ...
            for (Curso cu : listaCursos) {
                ...
                table.addCell(new Paragraph(cu.getCurso()));
                table.addCell(new Paragraph(cu.getDescripcion_curso()));
                table.addCell(new Paragraph(cu.getFecha_creacion()));
