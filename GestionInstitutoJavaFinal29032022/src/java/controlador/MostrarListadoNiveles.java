/*
Servlet para mostrar el listado de niveles
 */
package controlador;
 ...
 * @author daw2
 */
public class MostrarListadoNiveles extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        getServletContext().getRequestDispatcher("/admin/mostrarNiveles.jsp").forward(request, response);
    }
