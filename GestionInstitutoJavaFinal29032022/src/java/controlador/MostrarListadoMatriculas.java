/*
Servlet para mostrar el listado de matriculas
 */
package controlador;
 ...
 * @author daw2
 */
public class MostrarListadoMatriculas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       MatriculaJpaController mjc = new MatriculaJpaController(emf);
        ...
        getServletContext().getRequestDispatcher("/admin/mostrarMatriculas.jsp").forward(request, response);
