/*
Servlet para crear una grafica de notas de un alumno
 */
package controlador;
 ...
 * @author daw2
 */
public class GraficaNotas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String error = null;
        List<Evaluacion> listaNotas = null;
        ...
        listaNotas = consultaE.getResultList();

        emf.close();

        request.setAttribute("listaNotas", listaNotas);
        getServletContext().getRequestDispatcher("/admin/graficaNotas.jsp").forward(request, response);
    }
