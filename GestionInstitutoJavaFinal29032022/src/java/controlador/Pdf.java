/*
Servlet para mostrar listado de todas las notas de alumnos en pdf
 */
package controlador;
...
public class Pdf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Paragraph parrafo1 = new Paragraph("Listado de notas de todos los alumnos", fuente);
            ...
            table.addCell(new Paragraph("Apellidos"));
            ...
            document.add(parrafo1);
//
//            document.add(new Paragraph("Listado de notas de todos los alumnos"));
//            document.add(new Paragraph(" "));
//            document.add(new Paragraph("Dni    Nombre     Apellidos   Nota   Observacion"));
//
//            for (Evaluacion ev : listaEvaluaciones) {
//
//                document.add(new Paragraph(ev.getAlumno().getDni_alumno() + "     " + ev.getAlumno().getNombre_alumno()
//                        + ev.getAlumno().getPrimer_apellido_alumno() + " " + ev.getAlumno().getSegundo_apellido_alumno() + "            "
//                        + ev.getNota() + "             " + ev.getObservacion()));
//            }
            document.close();
            emf.close();
