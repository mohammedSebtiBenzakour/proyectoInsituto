...
public class Registrar_alumnos implements Serializable {
    ...
    @ManyToOne
    @JoinColumn(name = "nivel_alumno")
    private Nivel_instituto nivel_alumno;
    ...
    public Registrar_alumnos(Long id, String imagen_alumno, String dni_alumno, String nombre_alumno, String primer_apellido_alumno, String segundo_apellido_alumno, String genero, String email_alumno, String telefono_alumno, Nivel_instituto nivel_alumno, String calle_alumno, String ciudad_alumno, String cp_alumno, Date fecha_nacimiento_alumno, String pais_alumno, String creado_el, List<Matricula> listaMatriculaciones) {
        this.id = id;
    ...
    public Nivel_instituto getNivel_alumno() {
        return nivel_alumno;
    }

    public void setNivel_alumno(Nivel_instituto nivel_alumno) {
        this.nivel_alumno = nivel_alumno;
    }
