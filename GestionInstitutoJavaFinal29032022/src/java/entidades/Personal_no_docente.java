/*
 Entidad Registrar Personal no docente
 */
package entidades;
...
public class Personal_no_docente implements Serializable {
    ...
    public Personal_no_docente(Long id, String dni, String nombre, String apellidos, Perfiles perfil, String usuario, String clave, String email, Departamento_instituto departamento, String ciudad, String pais, String direccion, Date fecha, String telefono, String fecha_registro) {
        this.id = id;
        this.dni = dni;
        this.nombre = nombre;
