                        ...
                        <div class="form-content">
                            <div class="form-items">
                                ...
                                <form class="requires-validation" novalidate action="ModificarCurso" method="post">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" type="text" name="curso" placeholder="Año Curso" value="${curso}" required>
                                        <div class="valid-feedback">Año Curso field is valid!</div>
                                        <div class="invalid-feedback">Año Curso field cannot be blank!</div>
                                    </div>

                                    <div class="col-md-12">
                                        <input class="form-control" type="text" name="descripcion_curso" value="${descripcion_curso}" placeholder="Descripción Curso" required>
