        ...
        <section class="portafolio">
            <div class="contenedor">
                ...
                <section class="galeria">
                    <div class="fotos">
                        <h5><a href="MostrarListadoEvaluaciones" class=""> <img src="../imagenes/2.jpg" alt="">Mostrar Listado Evaluaciones</a></h5>
                    </div>
                    <div class="fotos">
                        <h5><a href="insertarEvaluacion.jsp" class=""><img src="../imagenes/3.jpg" alt="">Insertar Una  Evaluacion</a></h5>
                    </div>
                    <div class="fotos">
                        <h5><a href="PdfEvaluaciones" class=""> <img src="../imagenes/4.jpg" alt="">Generar listado de evaluaciones en pdf</a></h5>
                    </div>
                </section>
            </div>
        </section>
