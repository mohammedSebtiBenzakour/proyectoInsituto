...
<html>
    ...
    <body onload='${empty param.mensaje?"":"mostrarMensaje()"}'>
                    ...
                    <div class="form-holder">
                        <div class="form-content">
                            <div class="form-items">
                                <h3>Insertar un Nivel</h3>
                                <p>Completar todos los campos.</p>
                                <form class="requires-validation" novalidate action="InsertarNivel" method="post">

                                    <div class="col-md-12">
                                        <input class="form-control" type="text" name="nivel" placeholder="Nombre Nivel" required>
                                    ...
                                    <div class="form-button mt-3">
                                        <button id="submit" type="submit" class="btn btn-primary" name="insertarNivel">Insertar Nivel</button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <footer class="container mb-5 d-flex justify-content-center align-items-center btn btn-warning shadow rounded text-uppercase botonInicio">
            <h2><a href="gestionNiveles.jsp" class="botonInicio">Volver</a></h2>
        </footer>
