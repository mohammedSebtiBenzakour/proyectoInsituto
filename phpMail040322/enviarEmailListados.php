...
<body>
	<div class="container">
		<h1 class="mt-4 d-flex justify-content-center align-content-center">Enviar listados por email</h1>
			...
			<div class="row clearfix d-flex justify-content-center">
				<div class="col-md-8 col-sm-12 col-xs-12 mt-3">
					...
					<div class="form-group mt-3">
						...
						<input type="email" value="<?php echo $email; ?>" placeholder="Introducir Email Destinatario" name="email" required class="form-control shadow p-3 mt-3 bg-body rounded">
					</div>
					<div class="form-group mt-3">
				...
				<div class="col-md-8 col-sm-12 col-xs-12 mt-3">
					<div class="form-group">
						...
						<textarea name="message" placeholder="Escribe aquí vuestro mensaje (No olvidar adjuntar el listado en formato pdf/xml/xls)" class="form-control shadow p-3 mt-3 bg-body rounded" required></textarea>
					</div>
				</div>
