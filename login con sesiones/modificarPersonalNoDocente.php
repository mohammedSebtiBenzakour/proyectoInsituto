...
$consultar = "SELECT * FROM personal_no_docente  WHERE dni = '$id'";
	...
	<nav class="navbar navbar-expand-lg navbar-light  bg-light ">
		...
		<div class="row">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Modificar Personal No Docente</li>
				</ol>
			</nav>
		</div>
		...
		while ($row = mysqli_fetch_assoc($query)) {
			...
			<div class="container d-flex justify-content-center mb-3">
				...
				<form action="procesar_modificarPersonalNoDocente.php" method="POST" class="form-control w-50">
