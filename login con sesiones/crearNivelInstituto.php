...
// echo "<h2></h2>";
	...
	<center>
		<div class="container">
			...
			<div class="row">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Crear o añadir nivel educativo</li>
					</ol>
				</nav>
			</div>
			<div class="row">
				...
				<form action="procesarCrearNivelInstituto.php" method="POST" class="row g-3 needs-validation" novalidate>
					<div class="row d-flex justify-content-center">
						<div class="col-md-6 ">
							<label for="validationCustom01" class="form-label">Añadir nivel educativo</label>
							<input type="text" class="form-control" id="validationCustom01" value="" name="nombre_nivel" required>
					...
					<div class="col-12">
						<button class="btn btn-primary" type="submit">Registrar nivel educativo</button>
					</div>
				</form>
			</div>
			<div class="row">
			...
			<div class="row p-4">
				<div class="col">
					<a class="btn btn-outline-info" href="crearNivelInstituto.php" role="button">Reiniciar</a>
				</div>
				<div class="col">
