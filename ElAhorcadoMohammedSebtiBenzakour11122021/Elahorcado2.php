    ...
    <body>
        ...
        //guardo la variable nombre recogida al enviar desde Elahorcado1.php para conservarla 
         ...
         //compruebo que el nombre introducido cumple el pattern establecido
           ...
           $pattern = "/^[a-z]+$/i";
           $resNombre =  preg_match($pattern, $_SESSION["nombre"]);
   ...
   // echo " <br> la palabra a adivinar  al azar es : " . $palabra . " ";
    ...
    echo "<br><label class='lab'> Una simple pista para jugar la palabra es de " . strlen($palabra) . " letras.</label>";
   ...
   if ($intentos == 6) {
    ...
    echo '<br>';
    echo "<a href='Elahorcado1.php'>Vuelva a jugar</a>";

}else{
   echo '<p align="center" class="intentosF">Lleva ' . $intentos . '  intentos fallidos</p>';
}
...
<div>
    ...
    <form action="<?= $_SERVER["PHP_SELF"]; ?>" name="formulario" method="POST" enctype="multipart/form-data">
        ...
        if ($intentos != 0) {
            echo '<p align="center" class="intentos">Llevas ' . $intentos . '  intentos fallidos</p>';
        }
        ...
        if ($intentos != 6) {
         ...
         echo ' <span class="let1"><label for="letra">Introduce una letra:</label> <input type="text" name="letra" value="" class="letra" id="letra" placeholder="Solo estan permitidos letras sin accento" required title="Solo estan permitidas letras sin accento" pattern="[A-Za-z]{1}"></span><br><br>';

         ?>
         <input type="reset" value="Borrar" class="borrar">
         <input type="submit" value="Enviar letra" name="enviar" class="enviar">
     </form>


     <br><br>
     <p class="a">
        <a href="Elahorcado1.php" class="volver1">Volver a jugar</a>
    </p>
...
<br><br>
<!-- <p class="a">
    <a href="Elahorcado1.php">Volver a jugar</a>
</p> -->
</div>
</center>
<?php 
