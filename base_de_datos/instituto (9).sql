...
--
-- Servidor: localhost
-- Tiempo de generación: 08-06-2022 a las 18:27:55
-- Versión del servidor: 10.2.7-MariaDB
...
CREATE TABLE `insertar_noticias` (
  `id` bigint(20) NOT NULL,
  `creado_el` varchar(255) DEFAULT NULL,
  `nombre_noticia` longtext DEFAULT NULL,
  `texto_noticia` longtext DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
('Diseño', 'Mejor materia del mundo0', '2022-03-20 15:02:45', 1401, '1'),
('Electronica', 'Electronica detallada 234', NULL, NULL, '22334455d'),
('Empresa', 'Mejor materia del mundo0', NULL, NULL, '22334455z'),
('Entorno cliente', 'Mejor materia del mundo055555', NULL, NULL, 'b'),
('Fisica', 'Mejor materia del mundo0444444', NULL, NULL, '22334455x'),
('HLC', 'Mejor materia del mundo07889', NULL, NULL, '11'),
('java2', 'Mejor materia del mundo0', '2022-04-02 12:25:51', NULL, '1'),
('Programacion', 'ssaSDSSAMejor materia del mundo0', NULL, NULL, '111'),
('Quimica', 'Quimica Organica', '2022-03-27 21:18:32', 1601, '22334455z');
...
CREATE TABLE `registrar_alumnos` (
  ...
  `ID` bigint(20) DEFAULT NULL,
  `imagen_alumno` longtext DEFAULT NULL,
