                        ...
                        <div class="form-content">
                            <div class="form-items">
                                ...
                                <form class="requires-validation" novalidate action="InsertarMateria" method="post">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" type="text" name="descricpion" value="${descripcion_materia}" placeholder="Descripción Materia" required>
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-select mt-3" required name="profesor">
                                            ...
                                            %>
                                            <option value="${dni_profesor}" selected><%=profe.getNombre()%><%=profe.getApellidos()%></option>
                                            <%
                                                }
                                            %>
                                        </select>
