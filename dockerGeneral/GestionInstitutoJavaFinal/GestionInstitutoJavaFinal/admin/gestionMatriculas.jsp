...
<html>
    <head>
        ...
        <link href="../css/estilosMatriculas.css" rel="stylesheet" type="text/css"/>
    ...
    <body onload='${empty param.mensaje?"":"mostrarMensaje()"}'>
        ...
        <h1 class="d-flex justify-content-center  ">Gestion de matriculas</h1>
        ...
        <section class="contenedor-imagenes">
            <div class="imagen">
                ...
                <div class="overlay">
                    <h2><a href="MostrarListadoMatriculas" class="esconderMenu">Mostrar Listado de Matriculas</a></h2>
                </div>
            </div>
            <div class="imagen">
                <img src="../imagenes/1 (3).jpg" alt="">
                <div class="overlay">
                    <h2><a href="insertarMatricula.jsp" class="esconderMenu">Insertar Una Matricula</a></h2>
                </div>
            </div>
            <div class="imagen">
                <img src="../imagenes/1 (5).jpg" alt="">
                <div class="overlay">
                    <h2><a href="PdfMatriculas" class="esconderMenu">Generar listado de matriculas en pdf</a></h2>
                </div>
            </div>
        </section>
