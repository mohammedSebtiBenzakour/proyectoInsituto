...
//                    document.getElementById("mostrarPaises").innerHTML = data;
            ...
            $('#profesor').change(function () {
                ...
                $('#materia').append('<option>Selectionar materia</option>');
                $('#matricula').find('option').remove();
                $('#matricula').append('<option>Selectionar matricula</option>');
                $('#evaluacion').find('option').remove();
                $('#evaluacion').append('<option>Selectionar evaluacion</option>');
